...
const newsletter: Newsletter = {
    display: true,
    title: <>Subscribe to {person.firstName}'s newsletter? i dont know why you would do that</>,
...
const home: Home = {
    ...
    subline: (
        <>
            Hey, Im <Text as="span" size="xl" weight="strong">FireTime</Text>, I make things on the internet. <br /> This is my website where I accasionaly post things here. See ya soon!
        </>
    ),
};
        ...
        skills: [
            {
                title: "Fire Clicker",
                description: (
                    <>A cookie clicker like game i made when i was bored</>
                ),
                tags: [
                    {
            ...
            },
            {
                title: "FTCL",
                description: (
                    <>FireTime Command Line. COMMING SOON</>
                ),
                tags: [
                    {
                        name: "SOON",
...
const gallery: Gallery = {
    path: "/gallery",
    label: "Gallery",
    title: `Images and Backrounds – Made By ${person.name}`,
